...
const API_URL='https://siva-crm-node.herokuapp.com/leads';
...
export default function ListUsers(){
    ...
    const [getStatus]= useState(['New','Contacted','Qualified','Lost','Canceled','Confirmed']);
    ...
    return(
                ...
                {leadsList.map((lead,index)=>{
                    return(
                        <tr key={index}>
                            ...
                            <th>{lead.contact}</th>
                            <th>{lead.status}</th>
                            <th><span><Button variant="warning" onClick={()=>editLead(lead._id)}>Edit</Button></span>
                             &nbsp; <span><Button variant="danger" onClick={()=>deleteLead(lead._id)}>Delete</Button></span>
                             </th>
                        </tr>
                    )
                })}
        ...
        <Modal show={newLead} onHide={handleClose}>
            ...
            <Modal.Body>
                ...
                <Button type="submit" onClick={addUpdateLead}>{addUpdate}</Button>
            </Form.Group>
                </Form>
            </Modal.Body>
        </Modal>
